  ...
  try {
    ...
    return new NextResponse(html, {
      headers: {
        ...
        "Content-Disposition": `inline; filename="fromthoughts-okrs-${forecastId}.html"`,
      },
    });
  } catch (error) {
...
<head>
  <meta charset="utf-8">
  <title>fromThoughts - Revenue Forecast & OKRs</title>
  <style>
...
<body>
  ...
  <p class="subtitle">${forecast.companyName || "Your Company"} • Generated by fromThoughts</p>
  ...
  <div class="footer">
    <p>Generated by fromThoughts • fromthoughts.com</p>
