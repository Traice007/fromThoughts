        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0; background-color: #f9fafb;">
          <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
            ...
            <div style="background: linear-gradient(135deg, #059669 0%, #0d9488 50%, #0891b2 100%); border-radius: 16px 16px 0 0; padding: 40px 30px; text-align: center;">
              <h1 style="color: white; margin: 0; font-size: 28px; font-weight: 700;">FounderVision</h1>
            ...
            <div style="background: white; padding: 40px 30px; border-radius: 0 0 16px 16px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05);">
              ...
              <p style="color: #4b5563; margin: 0 0 24px 0;">Thanks for signing up for FounderVision. Please verify your email address to activate your account and start building your execution plan.</p>
            ...
            <div style="text-align: center; padding: 24px 20px;">
              ...
              <p style="color: #d1d5db; font-size: 11px; margin: 16px 0 0 0;">
                © ${new Date().getFullYear()} FounderVision. All rights reserved.
              </p>
            </div>
          </div>
        </body>
...
export async function sendPaymentFailedEmail(
  ...
  try {
    ...
    const { error } = await getResend().emails.send({
      from: EMAIL_FROM,
      to: email,
      subject: "Action required: Payment failed for your FounderVision subscription",
      html: `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0; background-color: #f9fafb;">
          <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
            ...
            <div style="background: white; padding: 40px 30px; border-radius: 0 0 16px 16px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05);">
              ...
              <p style="color: #4b5563; margin: 0 0 24px 0;">We were unable to process your latest payment for your FounderVision subscription. This could be due to an expired card, insufficient funds, or a temporary issue with your payment provider.</p>
...
export async function sendSubscriptionExpiryWarningEmail(
  ...
  try {
    ...
    const { error } = await getResend().emails.send({
      from: EMAIL_FROM,
      to: email,
      subject: `Your FounderVision ${tier.toLowerCase()} plan ${urgencyText}`,
      html: `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0; background-color: #f9fafb;">
          <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
            ...
            <div style="background: white; padding: 40px 30px; border-radius: 0 0 16px 16px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05);">
              ...
              <p style="color: #4b5563; margin: 0 0 24px 0;">This is a friendly reminder that your FounderVision <strong>${tier.toLowerCase()}</strong> plan will expire on <strong>${expiryDate}</strong>.</p>
            ...
            <div style="text-align: center; padding: 24px 20px;">
              <p style="color: #9ca3af; font-size: 12px; margin: 0;">
                You're receiving this email because your FounderVision subscription is expiring soon.
              </p>
              <p style="color: #d1d5db; font-size: 11px; margin: 16px 0 0 0;">
                © ${new Date().getFullYear()} FounderVision. All rights reserved.
              </p>
...
export async function sendSalesLeadConfirmationEmail(
  ...
  try {
    const { error } = await getResend().emails.send({
      from: EMAIL_FROM,
      to: email,
      subject: "Thanks for reaching out to FounderVision",
      html: `
        <!DOCTYPE html>
        <html>
        <head>
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0; background-color: #f9fafb;">
          <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
            ...
            <div style="background: white; padding: 40px 30px; border-radius: 0 0 16px 16px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.05);">
              ...
              <p style="color: #4b5563; margin: 0 0 24px 0;">We've received your message and a member of our team will be in touch within 24 hours to discuss how FounderVision can help your organization.</p>
            ...
            <div style="text-align: center; padding: 24px 20px;">
              <p style="color: #d1d5db; font-size: 11px; margin: 0;">
                &copy; ${new Date().getFullYear()} FounderVision. All rights reserved.
              </p>
            </div>
          </div>
        </body>
